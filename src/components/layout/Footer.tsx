      ...
      <div className={`${styles.inner} container`}>
        ...
        <div className={styles.brand}>
          <a href="/" className={styles.logo}>
            <span className={styles.logoAccent}>7K</span>
            <span className={styles.logoText}>anime</span>
          </a>
          <p className={styles.description}>
            Tu plataforma premium de streaming de anime y manga.
            Disfruta del mejor contenido en alta calidad.
          </p>
        </div>
        ...
        <div className={styles.links}>
          <div className={styles.section}>
            ...
            <a href="/" className={styles.link}>Anime</a>
            <a href="/manga" className={styles.link}>Manga</a>
          </div>
      ...
      <div className={styles.bottom}>
        <div className={`container ${styles.bottomInner}`}>
          <p className={styles.copyright}>
            © {new Date().getFullYear()} 7Kanime. Todos los derechos reservados.
          </p>
          <div className={styles.social}>
            <span aria-label="Discord">
