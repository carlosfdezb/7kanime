...
export function Header({ onSearch, showFavorites = false, onToggleFavorites }: HeaderProps) {
  ...
  const isAnimeActive = location.pathname === '/' || location.pathname.startsWith('/anime') || location.pathname.startsWith('/episode');
    ...
    <header className={cn(styles.header, isScrolled && styles.scrolled)}>
      <div className={styles.inner}>
        ...
        <nav className={styles.nav} aria-label="Navegación principal">
          <Link to="/" className={cn(styles.navLink, isAnimeActive && styles.navLinkActive)}>Anime</Link>
          <Link to="/manga" className={cn(styles.navLink, isMangaActive && styles.navLinkActive)}>Manga</Link>
        </nav>
        ...
        <div className={styles.actions}>
          ...
          {isAuthenticated && (
            <Button
              ...
              className={cn(styles.favoritesBtn, showFavorites && styles.favoritesBtnActive)}
              data-tv-focus="true"
          ...
          <form className={cn(styles.searchForm, showSearch && styles.open)} onSubmit={handleSubmit} data-tv-focus="true" data-tv-focus-id="search-form">
